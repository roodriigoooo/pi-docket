...
| Worker Conflicts | `extensions/worker-conflicts.ts` | Edited-file overlap detection across workers; the cheap path-level warning the dock and dashboard render every pass. |
